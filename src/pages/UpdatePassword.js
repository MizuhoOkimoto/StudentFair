  ...
  function ChangePasswordPage(prop){
    ...
    const onSubmitHandler = (e) => {
      ...
      if( e.target.newPassword.value === e.target.rePassword.value) {
        ...
        axios.post('http://localhost:8080/users//rest-password', updatedData).then((res) => {
    ...
    return (
      <div className="signUp-container">        
        <form className="user-form sign-up" action="/" method="POST" onSubmit={onSubmitHandler}>
          ...
          <div className="input-container">
            <input type="text" name="newPassword" id="newPassword" placeholder="Please Enter New Password" />
            <i className="fas fa-lock"></i>
            <div className="error"></div>
          </div>
          <div className="input-container">
            <input type="text" name="rePassword" id="rePassword" placeholder="Please Re-Enter New Password" />
            <i className="fas fa-lock"></i>
            <div className="error"></div>
          </div>
