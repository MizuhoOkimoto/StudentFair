  ...
  return (
    <>
      <Alert variant="danger" style={{ width: '700px', margin: '30px auto' }}>
        ...
        <p>
          Report post requires Sing up/Log in. Please Log in and submit your report.
          <br />
        ...
        >
          <div>
            <Link to="/signUp" style={{ margin: '20px', color: 'blue' }}>
              Sign Up
            </Link>
          </div>
          <div>
            <Link to="/logIn" style={{ margin: '20px', color: 'blue' }}>
              Log in
            </Link>
          </div>
          <div>
            <Link to="/customerService" style={{ margin: '20px', color: 'blue' }}>
              Contact Us
            </Link>
          </div>
        </p>
      ...
      <div className="signUp-container">
        <form className="user-form sign-up">
          ...
          <div className="input-container">User Email</div>
          <div className="input-container">User Name</div>
